...
namespace Data
{
    public abstract class DataLayerAbstractAPI
    {
        ...
        public abstract InterfaceClient GetClient(int id);
        public abstract IEnumerable<InterfaceClient> GetAllClients();
        //////////////////////////////////////////
        ...
        public abstract InterfaceProdcut GetProduct(int id);
        public abstract IEnumerable<InterfaceProdcut> GetAllProducts();
        //////////////////////////////////////////
        ...
        private class DataLayerConcrete : DataLayerAbstractAPI
        {
            ...
            {
                return (InterfaceClient) context.Clients.FirstOrDefault(x => x.ClientID == id);
            }

            public override IEnumerable<InterfaceClient> GetAllClients()
            {
                var clients = from x in context.Clients
                              select (InterfaceClient) x;
            ...
            public override InterfaceProdcut GetProduct(int id)
            {
                return (InterfaceProdcut) context.Products.FirstOrDefault(x => x.ProductID == id);
            }

            public override IEnumerable<InterfaceProdcut> GetAllProducts()
            {
                var products = from x in context.Clients
                               select (InterfaceProdcut) x;
